...
describe('concat', () => {
  it('should concat hey & Jude', () => {
    const result = concat('hey', 'Jude');
    expect(result).to.equal('heyJude');
  });

  it('should concat whats & up', () => {
    const result = concat('whats', 'up');
    expect(result).to.equal('whatsup');
  });
